 ...
 * Based on Demo Sensortag app ti-sensortag-cc2650-demo
 */
var app = {};
...
/*
 * XMLHTTP Request test to load a local file
 * this file is local at this stage so no test for remote access
 * Server access version more suitable as below
 *
app.loadDoc = function()
{
...
Had the following in index file:
	<div id="demo"><p>Document Loaded on Click from file existing when app launched</p></div>
	<button type="button" onclick="app.loadDoc()" class="green">Download Local ExpConfig File</button>
*/

/*
 * iFrame test to load a local file
 * this file is local at this stage so no test for remote access
 * Cannot be used across domains - dont think this solution is suitable
 *
app.loadDocIFrame =	function() 
{
		var myFrame = document.getElementById('ifrm');
		myFrame.src="test.txt";
	    myFrame.style.display = 'block';
	    myFrame.style.visibility = 'visible';
};
Had the following in index file
	<p>Testing by filling hidden iFrame</p> 
	<iframe id="ifrm" name="frame" width="100%" height="30" frameborder="2" style="visibility:hidden;display:none"></iframe>
	<button type="button" onclick="app.loadDocIFrame()" class="green" >Download Local ExpConfig File (IFrame)</button>
*/
