...
;(function()
{
	...
	sensortag.addInstanceMethods = function(anInstance)
	{
		...
		instance.deviceIsSensorTag = function(device)
		{
			return (device != null) &&
				...
				((device.advertisementData.kCBAdvDataLocalName ==
					'CC2650 SensorTag') || (device.advertisementData.kCBAdvDataLocalName ==
					'SensorTag 2.0'))
				// NOTE - changed because new sensorTags have new advertised name
		}
		...
		instance.setupCatchAllMovementCallback = function(interval)
		{
			...
			//console.log("DEBUG - tisensortag-ble-cc2650-nerld.js Catching all movement " + instance.catchAllMovementCallbackEnabled)
